...
RowViewは固定サイズを廃止し、タイトルの複数行表示とDynamic Typeに応じて高さを決めます。UISwitchの幅と読み上げラベルを維持します。設定画面はスクロールでき、短い画面でも下の項目へ到達できます。

狭い幅、長いタイトル、UISwitchの幅、大きい文字サイズ、短い画面のスクロールをUIKit上で検証します。
